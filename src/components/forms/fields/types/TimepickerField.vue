...
import type { DateFieldProps } from './FormFieldTypes'
...
const isTimeModel = (value: ModelValue): value is TimeModel => {
    value = value as TimeModel;
    return value && typeof value.hours === 'number' && typeof value.minutes === 'number'
}

//TODO: Test this
watch(internalValue, (newValue) => {
    if (isTimeModel(newValue)) {
        newValue = newValue as TimeModel;
        const timestring =
